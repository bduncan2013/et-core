...
(function (window) {
	...
	// !!!!!!! NOTES 3-15-14 !!!!!!!!
	// createalldtos split into TWO functions to make testing
	// simpler. createalldtos contains the "critical dtos" for testing and the 
	// new function noncriticaldtos contains the "non-critical dtos" for testing
...
// the critical dtos have relationships with non-critical dtos.
	exports.noncriticaldtos = noncriticaldtos = function noncriticaldtos(params, callback){
