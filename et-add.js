...
<<<<<<< HEAD
        ...
        addtomongo(converttodriformat(inputObject), function (err, results) {
            ...
            // var i = 5 / 0; // intentional error producer
...
<<<<<<< HEAD
        ...
        //callback ({"status":"there was an error"}, {"function":"addwidmaster"});        
            ...
            function step1(step1_callback) {
                if (relationshiptype === "onetoone") {
                    ...
                    execute(executeobject, function (err, widset) {
                        ...
                        step1_callback(null); // changing this will stop data from
                                              // being stored in local storage
                    });
                }
                else {
                    step1_callback(null); // changing this from null will break wd2..
                                          // a test for addwidmaster/getwidmaster
                }
