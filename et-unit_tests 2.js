...
exports.etd16 = etd16 = function etd16(params, callback) {
	...
	async.series([
		function (cb1){
			var dtoObjOpt = {"b":"boolean", "s":"string", "n":"number", "i":"integer", "d":"date", "sg":"shortguid", "g":"guid", "h":"hash", "p":"phone", "r":"random4"};
			var inputObj = {"b":"false", "s":"hello", "n":"30", "i":"40", "d":"2/27/2014", "h":"ff00ff","p":"19998887777"};
			var command = {"command.deepfilter.convert":true};
