(function (window) {
    //***************************************************************************************
    // et-testdata --- create data for the tests
    //***************************************************************************************
    var data = function () {
    ...
    //***************************************************************************************
    // et-dto --- create dtos needed for security purposes
    //***************************************************************************************
    ...
    var dto = function () {
        ...
        exports.createalldtos = createalldtos = function createalldtos(params, callback) {
            ...
            execute([{
                ...
                "collection": "string",
                "level": "string",
                "metadata.interfacedto.type": "manytoone", // <-- no more?
                "metadata.actionset.type": "manytoone", // <-- no more?
    ...
    var security = function () {
        ...
        // user1 can put user2 in their group
        // user 2 is not mentioned in user 1 group

        // user 111 wants to do action 222
        ...
        // find where action 222 is mentioned …. recurse on that result
        // get default actiongroups for 222
        // add calculate + default action groups for 222
        // find where _mygroup is mentioned ... recurse on that result

        // "the original action had an owner
        // we are only interested in him

        // the original action ... (i.e I want to to x)
        // x has an owner
        // the owner of x is in its metadata.systemdto.owner field
        // "
