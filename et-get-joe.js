        ...
        async.series([
            ...
            function step2(cb) {
                if ((parameterObject!==undefined) && (parameterObject['metadata.method'] != "") && (parameterObject['metadata.method'] != targetwid))  {
                    ...
                    moreDTOParameters = executethis(executeobject,getwid);// TODO
                ...
                x = window['querywid'];
                moreDTOParameters = executethis(executeobject,x);// TODO
                    ...
                    )
                {
                    ...
                    for (item in dtoobject) {
                        ...
                        if (proposedRight == 'inherit') {
                            ...
                            moreParameters=executethis(executeobject,getwidmaster);// TODO
        ...
        async.series([
            ...
            function step2(cb) {
                ...
                if(inherit) { // inherit points to wid with more datan- Grab the params from mongo(local storage)
                    ...
                    moreParameters=executethis(executeobject,getwid);//TODO
    ...
    function getWidMongo(widInput, convertMethod, accessToken, dtoin, callback) {
        ...
        if (!widInput) {
            ...
            async.series([
                function part1(cb) {
                    executeobject["wid"]=widInput;
                    currentLevelObject = executethis(executeobject,getwid);//TODO
                    cb(null, 'one');
                },
                function step2(cb) {
                    if ((currentLevelObject["metadata.method"]!==undefined) &&
                        ...
                        dtoGlobalParameters= executethis(executeobject,getwid);//TODO
    ...
    function getAndFormatNextLevel(widInput, mongorelationshiptype, mongorelationshipmethod, mongorelationshipdirection, mongowidmethod, convertmethod, accesstoken, dtoin, callback) {
        ...
        async.series([
            function part1(cb) {
                ...
                executeobject["dtotype"]="";
                executeobject["executethis"]=querywid;
                relatedParameters = executethis(executeobject,querywid);//TODO
                cb(null, 'one')
            },
            function part2(cb) {
