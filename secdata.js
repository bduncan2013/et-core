...
exports.datasum = datasum = function datasum(params, callback) {
    ...
    execute(executeList, function (err, res) {
        proxyprinttodiv('Function datasum dtos -- added all this -- ', res, 99);
...
exports.sectest1 = sectest1 = function sectest1(parm, callback) {
    ...
    async.series([
            ...
            ,
            function (cb1) {
                testwip({}, function (err, res) {
                    proxyprinttodiv('Function sectest1 --  >>>>>> response from  testwip >>>>>   -- ', res, 99);
                    cb1(null);
                });
            }
...
exports.testwip = testwip = function (params, callback) {
    ...
    // var mongorawquery = '{"wid": "rogeruser" }';
